  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Browse through different collection of imaginative and visually stunning images generated by DALL-E AI </p>
      </div>
